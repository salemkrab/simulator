 ...
 * Il peut se déplacer sur une carte et éviter les obstacles grâce à
 * move(Direction dir).
 ...
 * L'aventurier ne peut pas se déplacer en dehors des limites de la carte ou sur
 * des obstacles.
 * 
 * @author Ciril Group
 * @version 1.0
...
public class Adventurer {
    ...
    /**
     * Déplace l'aventurier dans la direction spécifiée si le mouvement est
     * possible.
     * Vérifie que la nouvelle position est à l'intérieur de la carte et n'est pas
     * un obstacle.
     * Si le mouvement est valide, met à jour la position de l'aventurier.
     * Si le mouvement n'est pas valide, la position de l'aventurier reste
     * inchangée.
     * 
